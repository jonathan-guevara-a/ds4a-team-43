...
base_df = base_df[base_df["fechahora"].dt.year < 2015]
...
year_crime_line_figure = px.line(
    grouped_year_crime_df[~grouped_year_crime_df["tipo_crimen"].isin(["HURTO PERSONAS", "LESION PERSONAL", "TERRORISMO", "ABIGEATO", "AMENAZA", "HURTO ENTIDAD COMERCIAL"])],
    x = "anio",
    y = "cantidad",
    color = "tipo_crimen",
    height = 700,
